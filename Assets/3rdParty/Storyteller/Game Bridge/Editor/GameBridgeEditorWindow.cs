    ...
    public class GameBridgeEditorWindow : EditorWindow
    {
        ...
        public void OnEnable()
        {
            ...
            _componentData.AddMany(
                ...
                new ComponentData(ImageLibrary.GBDialogueImage, "Dialoguer",
                    "Processes and handles dialogue display") /*,
                new ComponentData(ImageLibrary.GBDialogueImage, "Text Adventure", "Generate Text adventure framework"),
                new ComponentData(ImageLibrary.GBDialogueImage, "Manga", "Manga/comic style game framework generator")*/);
        }
        ...
        public void OnGUI()
        {
            ...
            switch (EditID)
            {
                case 0:
                    ...
                    GUI.DrawTexture(ScreenRect.ToCenter(200, 200), ImageLibrary.GameBridgeIcon);
                ...
                case 1:
                   ...
                   /* if (SelectedSceneData.SceneID != -1)
                    ...
                    if (SelectedSceneData.SceneID == -1)
                    {
                        ...
                        Grid.BeginDynaicGuiGrid(newarea.AddRect(0, 20), scenesAreas, 20, 50, 65, 75,
                            story.Scenes.Count);
                    ...
                    else
                    {
                        ...
                        EditorGUI.HelpBox(characterSelectionAreaHeader.PlaceUnder(0, 40), "All characters are set to be pushed. Do not uncheck characters who have ties to checked characters (new Experimental)",MessageType.Info);
                        ...
                        if (GUI.Button(pushDataButtonArea, "Push To Scene Data"))
                        {
                            ...
                            for (var i = 0; i < sortedList.Count; i++)
                            {
                                ...
                                if (sortedList[i].GetType() == typeof(EnvironmentNode))
                                {
                                    ...
                                    // data.EnvironmentLocation = environment.e
                                }
                ...
                case 2:
                    ...
                    Grid.BeginDynaicGuiGrid(headerArea.PlaceUnder(0, Screen.height - headerArea.height), 1,
                        _componentData.Count + 1, _componentAreas, 0, 130, 0, 70);
                    componentsScrollView =
                        GUI.BeginScrollView(new Rect(0, 0, Screen.width, Screen.height - headerArea.height),
                            componentsScrollView, new Rect(0, 0, Screen.width, (_componentData.Count + 1) * 130 + 0),
                            false, false);
                    for (var a = 0; a < _componentData.Count + 1; a++)
                    {
                        var area = _componentAreas[a];
                        if (a != _componentData.Count)
                        {
                            ...
                            if (InfoBlock.Click(1, area, _componentData[a].Icons, SnapPosition.TopMiddle, Color.clear,
                                ...
                                _componentData[a].Description, 0, 0, 180, 60))
                                AttachComponen(a);
                        }
                    }
